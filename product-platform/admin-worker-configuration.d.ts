/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.admin.jsonc --env-file=/dev/null --strict-vars=false --env-interface=AdminEnv admin-worker-configuration.d.ts` (hash: fcb02a94ac0b48d19270d2fd9fc0bad6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WRITES_ENABLED" | "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "ACCESS_ADMIN_EMAIL">> {}
}
