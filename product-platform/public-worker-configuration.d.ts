/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.public.jsonc --env-file=/dev/null --strict-vars=false --env-interface=PublicEnv public-worker-configuration.d.ts` (hash: 42f06703f6bc1fef5e268c5d5a17822f)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/src/public");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENABLE_HSTS">> {}
}
